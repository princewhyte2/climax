    ...
    <main className="h-screen w-full">
      <div className="h-full w-full flex">
        ...
        <div className="w-full lg:max-w-[674px] ">
          <div className="relative h-full flex items-center justify-center bg-login-bg bg-no-repeat bg-cover lg:bg-none">
            <div className="absolute top-10 left-50 lg:hidden">
              <img src="/Climax.png" alt="logo" className="w-full h-full" />
            </div>
            <form
              action=""
              className="bg-white rounded-[15px] lg:rounded-none text-center mt-[55px] lg:mt-0 lg:text-left py-8 px-[26px] "
            >
              <div className="mb-[30px] w-full max-w-[299px] ">
                ...
                <p className="text-xs font-normal text-black leading-[18px] ">
                  Login to join the conversation on climate change and our part
                  in saving the earth
                </p>
              </div>
              <div className="mb-5">
