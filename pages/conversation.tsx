            ...
            <div className="max-w-[700px] w-full pb-[57px] ">
              <div className="w-full flex justify-between mb-5  ">
                ...
                <button
                  ...
                  onClick={status === "authenticated" ? openConversationModal : openLoginNotification}
                  type="button"
              ...
              {posts?.map((item: any, index: any) => (
                <div key={index} className="w-full h-fit border border-[#DDDDDD] rounded-[10px] bg-white mb-10  ">
                  <div className="flex items-center space-x-2 border-b border-[#E1E0E0] pb-[18px] px-8 pt-8 mb-2">
                    ...
                    <div>
                      <p className="text-lg leading-[27px] font-semibold capitalize text-black">{item.author.name}</p>
                      <p className="font-normal text-xs leading-[18px] text-black">{item.title}</p>
                    </div>
                  </div>

                  <p className="px-8 text-base text-black font-normal mb-20 ">{item.content}</p>
                  {item.previewImage ? (
                    <div className="w-full max-h-48 overflow-hidden">
                      <img src={item.previewImage} alt="feature" className=" h-auto block w-full" />
                    </div>
                  ) : null}
              ...
              <div className=" w-full">
                {outSource.map((item, index: number) => (
                  <div key={index} className="bg-[#DEDEDE2B] rounded-[5px] py-[9px] px-[15px] mb-[29px] ">
                    ...
                    <p className="font-normal text-base leading-[19px] text-black mb-4">{item.content} ...</p>
